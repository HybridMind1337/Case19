...
$mysql_check = mysqli_query($link, "SELECT * FROM advertise");
...
echo $tpl->render($values_acp + $contact_pm_acp + $values3_acp + $values4_acp + $is_banners_page_acp); //принтираме всичко в страницата ($values+$values)s